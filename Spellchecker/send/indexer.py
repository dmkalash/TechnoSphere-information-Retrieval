...
from utils import prepare_query, get_query_stat, get_model
from trie import *
...
def get_words_prior_dict(fname='queries_all.txt', stop_iter=3000):
...
if __name__ == '__main__':
    ...
    model, scaler = get_model(query_dict, trie, letter_dict, bigramm_words_dict, words_dict, words_prior_dict,
                              stop_iter=100)
